...
import static com.onlyvtc.driver.MvpApplication.isBraintree;
import static com.onlyvtc.driver.MvpApplication.isCard;
import static com.onlyvtc.driver.MvpApplication.isCash;
import static com.onlyvtc.driver.MvpApplication.isPaytm;
import static com.onlyvtc.driver.MvpApplication.isPayumoney;
...
public class PaymentActivity extends BaseActivity implements PaymentIView {
    ...
    public void onSuccess(Object card) {
        Toast.makeText(activity(), getString(R.string.card_deleted_successfully), Toast.LENGTH_SHORT).show();
        presenter.card();
    }
