    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.imgMail:
                ...
                intent.putExtra(Intent.EXTRA_TEXT, getString(R.string.hello_team));
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (!allPermissionsGranted) {
            ...
            if (allPermissionsGranted) {
                ...
                Toast.makeText(this, getString(R.string.you_do_not_assign_permission), Toast.LENGTH_SHORT).show();
            }
        }
    }
