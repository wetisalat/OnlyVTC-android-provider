...
import com.onlyvtc.driver.ui.activity.payment.PaymentActivity;
import com.onlyvtc.driver.ui.activity.request_money.RequestMoneyActivity;
import com.onlyvtc.driver.ui.adapter.WalletAdapter;
...
import static com.onlyvtc.driver.ui.activity.payment.PaymentActivity.PICK_PAYMENT_METHOD;
...
public class WalletActivity extends BaseActivity implements WalletIView {
    ...
    public void onSuccess(WalletResponse response) {
        ...
        tvWalletAmt.setText(MvpApplication.getInstance().getNewNumberFormat(walletAmt));
