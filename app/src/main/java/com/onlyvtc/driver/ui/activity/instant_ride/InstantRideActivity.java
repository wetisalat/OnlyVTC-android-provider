...
import com.onlyvtc.driver.common.RecyclerItemClickListener;
...
import com.onlyvtc.driver.ui.adapter.PlacesAutoCompleteAdapter;
import com.onlyvtc.driver.ui.countrypicker.Country;
import com.onlyvtc.driver.ui.countrypicker.CountryPicker;
        ...
        rvLocation.addOnItemTouchListener(new RecyclerItemClickListener(this, (view, position) -> {
                    ...
                    placeResult.setResultCallback(places -> {
                        if (places.getCount() == 1) {
                            ...
                            Toast.makeText(getApplicationContext(), getString(R.string.some_thing_wrong), Toast.LENGTH_SHORT).show();
                    });
                })
        );
...
//        }
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        ...
        Toast.makeText(this, getString(R.string.api_not_connected), Toast.LENGTH_SHORT).show();
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.qr_scan:
                ...
                intentIntegrator.setPrompt(getString(R.string.scan_qrcode));
