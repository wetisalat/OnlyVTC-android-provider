...
import com.onlyvtc.driver.common.CircularProgressBar;
...
import com.onlyvtc.driver.data.network.model.Ride;
import com.onlyvtc.driver.ui.adapter.EarningsTripAdapter;
...
import static com.onlyvtc.driver.common.Utilities.animateTextView;
...
public class EarningsActivity extends BaseActivity implements EarningsIView {
    ...
    private void loadAdapter(EarningsList earningsLists) {
        ...
        lblEarnings.setText(MvpApplication.getInstance().getNewNumberFormat(
