...
public class CardActivity extends BaseActivity implements CardIView {
    ...
    private void showCardDeleteAlert(Card card) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this)
                .setMessage(getResources().getString(R.string.are_sure_you_want_to_delete))
    ...
    public class CardAdapter extends RecyclerView.Adapter<CardAdapter.MyViewHolder> {
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            MyViewHolder(View view) {
                ...
                delete = view.findViewById(R.id.text_change);
