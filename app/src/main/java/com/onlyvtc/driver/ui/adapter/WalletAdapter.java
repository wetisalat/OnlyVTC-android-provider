...
import com.onlyvtc.driver.data.network.model.WalletTransation;
import com.onlyvtc.driver.ui.activity.wallet_detail.WalletDetailActivity;
...
public class WalletAdapter extends RecyclerView.Adapter<WalletAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (mWallets.get(position).getTransactions().get(0).getType().equalsIgnoreCase("C")) {
            ...
            holder.tvAmt.setText(MvpApplication.getInstance().getNewNumberFormat(mWallets.get(position).getAmount()));
