package com.onlyvtc.driver.data.network;
...
public interface ApiInterface {
    ...
    @FormUrlEncoded
    @POST("/api/provider/requests/upcoming/cancel")
    Observable<Object> assignedCancel(@FieldMap HashMap<String, Object> params);

    @FormUrlEncoded
    @POST("/api/provider/requests/upcoming/accept")
    Observable<Object> assignedAccept(@FieldMap HashMap<String, Object> params);
...
//    Observable<Object> sendFcm(@Body JsonObject jsonObject);
    ...
    @GET("/api/provider/get_advertisements")
    ...
    Observable<Object> dropItem(HashMap<String, Object> params);

    @GET("/terms_conditions")
    Observable<Object> getTermsConditionsUrl();

    @FormUrlEncoded
    @POST("api/provider/requestSMS")
    Observable<ResponseSMS> requestSMS(@FieldMap Map<String, String> params);

    @FormUrlEncoded
    @POST("api/provider/verifySMS")
